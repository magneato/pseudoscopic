...
echo -e "\n${YELLOW}[2/5] Building kernel module...${NC}"
...
# NOTE: This MUST come after 'make install' because the Makefile install
# target writes a default modprobe config. We overwrite it here with
# the production settings.
echo -e "\n${YELLOW}[3/5] Configuring driver options...${NC}"
